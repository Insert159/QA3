...
## **Содержание**
  ...
  - [Глава 3](#глава-3)
    ...
    - [Задание 4. Попарное тестирование](#задание-4-попарное-тестирование)
...
1. Укажи, какими символами от каждого класса будешь тестировать (одно-два значения).
...
4. Решение оформи в файле *task\_3.md.*
...
2. На основе чек-листа по проверке раздела «Как мы учим» https://21-school.ru/methodology  «Школы 21», разработанного тобой в Задании 2 проекта QA2_Test artifacts предложи минимум 2 варианта тестового тура. Сначала подумай об идеях туров самостоятельно.
